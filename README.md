...
I've updated the config.c with **Debounce 5ms, Polling rate 500Hz (2ms),** and some other, see in the **config.h** file inside keymap/via (if you want 1000Hz (1ms)change the USB_POLLING_INTERVAL_MS FROM **2 TO 1**
